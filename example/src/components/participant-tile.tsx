...
export function ParticipantTile({
	...
	return (
		<div
			...
			{...props}
		>
			<div className="absolute border border-zinc-200 bottom-3 left-3 bg-white/60 z-10 backdrop-blur-md rounded-md px-2">
				{participant.name}
			</div>
			...
			<div
				className={clsx(
					'absolute -z-10 top-1/2 left-1/2 -translate-1/2 text-4xl size-20 bg-orange-400 text-white rounded-xl flex items-center justify-center',
				)}
			>
